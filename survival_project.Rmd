...
Kaplan-Meyer estimator[@km1958non] is non-parametric method to estimate survival probability.
...
```{r, echo=FALSE, message=FALSE, results=FALSE, warning=FALSE,fig.height=6,fig.width=14 }
